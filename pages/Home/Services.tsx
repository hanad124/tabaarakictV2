  ...
  return (
    <div className="" style={{ background: "rgba(11, 99, 229, 0.05)" }}>
      <div className="py-14 max-w-7xl mx-auto px-4 sm:px-6 lg:px-4 ">
        ...
        <p className="text-custom_textColor my-7  leading-relaxed text-center mx-3">
          Our ICT solutions are designed to help you streamline your business
          processes, save time, and reduce costs 💰.
        </p>
