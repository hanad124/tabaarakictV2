  ...
  return (
    <div>
      <div className="py-16 container mx-auto px-4 sm:px-6 lg:px-8">
        <p className="text-center text-custom_primary font-bold text-lg flex justify-center items-center gap-2">
        ...
        <div className="flex flex-wrap justify-center gap-5 md:gap-10 mt-16">
          ...
          >
            ...
            <div className="flex flex-col gap-1">
              <div className="text-custom_primary   text-2xl font-medium">
                <Counter offsetend={4} speed={1} end={13} />
          ...
          >
            ...
            <div className="flex flex-col gap-1">
              <div className="text-custom_primary   text-2xl font-medium">
                <Counter offsetend={4} speed={1} end={18} />
          ...
          >
            ...
            <div className="flex flex-col gap-1">
              <div className="text-custom_primary   text-2xl font-medium">
                <Counter offsetend={4} speed={1} end={179} />
          ...
          >
            ...
            <div className="flex flex-col gap-1">
              <div className="text-custom_primary   text-2xl font-medium">
                <Counter offsetend={4} speed={1} end={311} />
