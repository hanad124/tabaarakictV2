          ...
          <div className="pt-44 max-w-7xl mx-auto px-4 sm:px-6 lg:px-4">
            <div className="flex flex-col md:flex-row md:justify-between items-center">
              <div className="md:w-1/2">
                <h1
                  className="lg:text-5xl  lg:mt-0 md:mt-0 text-4xl md:text-4xl sm:text-3xl leading-relaxed text-white font-bold mb-4 mt-6"
                ...
                <p className="text-white mt-[2rem] md:mt-0 lg:mt-0 lg:text-lg md:text-lg text-md mb-8 leading-relaxed">
                  At{" "}
                  <span className="font-semibold">`Tabaarak ICT Solutions`</span>,
                  we are dedicated to transforming businesses with our advanced
                  ICT solutions. Our focus is on delivering state-of-the-art
                  technologies that ignite growth, optimize efficiency, and
                  elevate customer experiences to unprecedented levels.
                </p>
