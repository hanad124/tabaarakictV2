        ...
        <form>
          <div className="flex items-center gap-3 w-full justify-between mb-4">
            <div className="flex-1">
              <label
                htmlFor="name"
                className="block mb-2 text-custom_secondary font-light text-sm"
              >
                Name
              </label>
              <input
                ...
                id="name"
                name="name"
                className="w-full px-4 py-2 border font-light text-custom_secondary border-gray-300 rounded-md focus:outline-none text-sm focus:ring-2 focus:ring-blue-400"
            ...
            <div className="flex-1">
              <label
                htmlFor="email"
                className="block mb-2 font-light text-sm text-custom_secondary"
              >
                Email
              </label>
              <input
                ...
                id="email"
                name="email"
                className="w-full px-4 py-2 font-light text-sm text-custom_secondary border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400"
          ...
          <div className="mb-4">
            <label
              htmlFor="subject"
              className="block mb-2 text-sm  font-light text-custom_secondary"
            >
              Subject
            </label>
            <input
              ...
              id="subject"
              name="subject"
              className="w-full px-4 py-2 border font-light text-sm text-custom_secondary border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400"
              placeholder="Subject"
              required
            />
          </div>
          <div className="mb-4">
            ...
            <input
              ...
              id="company"
              name="company"
              className="w-full px-4 py-2 border font-light text-sm text-custom_secondary 
