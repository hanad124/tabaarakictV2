...
const FeaturedPost = () => {
  ...
  let tempArr: PostMetadata[] = [];

  const featuredPost = postMetadata.map((post) => {
    tempArr.push(post);
    return tempArr;
  });
  ...
  return (
    <div className="flex justify-center">
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(to top, rgba(13, 21, 34, 0.75) 0%, rgba(0, 39, 98, 0.47) 40%), linear-gradient(to top, rgba(13, 21, 34, 0.9) 0%, rgba(0, 39, 98, 0.3) 30.98%),url(${featuredPost[0][0].image})`,
        }}
      >
        <div className="mb-10">
          <Badge
