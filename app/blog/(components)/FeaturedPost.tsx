...
const FeaturedPost = () => {
  return (
    <div>
      <div className="featured-post bg-cover bg-center h-full md:h-[26rem] rounded-xl flex flex-col pt-16 md:pt-0 justify-center md:justify-end px-4 md:px-6 lg:px-8">
        <div className="mb-10">
          <Badge
            variant="default"
